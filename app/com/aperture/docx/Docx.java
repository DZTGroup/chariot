...
public class Docx {
	...
	public Docx() throws InvalidFormatException {
	...
	// comments related
	public void createComment(java.math.BigInteger commentId, String author,
			String message) {
	...
	public static void removeUncontained(Object part, Collection<Object> whiteList){
